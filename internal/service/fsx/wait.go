...
func waitDataRepositoryAssociationCreated(conn *fsx.FSx, id string, timeout time.Duration) (*fsx.DataRepositoryAssociation, error) { //nolint:unparam
	stateConf := &resource.StateChangeConf{
...
func waitDataRepositoryAssociationUpdated(conn *fsx.FSx, id string, timeout time.Duration) (*fsx.DataRepositoryAssociation, error) { //nolint:unparam
	stateConf := &resource.StateChangeConf{
...
func waitDataRepositoryAssociationDeleted(conn *fsx.FSx, id string, timeout time.Duration) (*fsx.DataRepositoryAssociation, error) { //nolint:unparam
	stateConf := &resource.StateChangeConf{
